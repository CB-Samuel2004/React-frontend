    ...
    <Box>
      ...
      >
        ...
        <Typography variant="h6" sx={{ mt: 2 }}>
          Pay lesser selling fee* with every order on India's most visited online shopping destination
        </Typography>
        <Button
          variant="contained"
          sx={{
          ...
          {[
            {
              ...
              description: "Register on TechTrove by clicking the Signup or Login button",
              img: l2,
            },
            {
          ...
          {[
            {
              ...
              description: "Click confirm after providing product and brand details",
              img: l4,
            },
            {
              title: "STEP 4: Complete orders & get paid",
              description: "Deliver orders to customers on time and get paid within 7 days of delivery.",
              img: l5,
            },
          ].map((step, index) => (
            <Grid item xs={12} sm={6} md={3} key={index}>
      ...
      <Typography variant="h4" fontWeight="bold" mb={4} mt={4} sx={{ textAlign: "center" }}>
        Add Your Product
      </Typography>
      <Box sx={{ p: 2 }}>
        {/* Alert */}
        ...
        <Box sx={{ display: "flex", flexDirection: "row", gap: 2, width: "100%" }}>
          ...
          <Box sx={{ flex: 1, display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <TextField
              ...
              helperText={errors.specification && "Specification is required."}
            />
            {/* Confirm Button */}
            <Button variant="contained" onClick={handleConfirm} sx={{
            padding: "0.8rem 2rem",
            borderRadius: "20px",
            fontWeight: "bold",
            textTransform: "none",
